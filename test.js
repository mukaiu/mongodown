...
var tingoDOWN = require('./');

function factory(location) {
  return new tingoDOWN(location);
}
...
require('abstract-leveldown/abstract/open-test').setUp(
  factory,
  test,
  testCommon
);
...
require('abstract-leveldown/abstract/open-test').tearDown(
  factory,
  test,
  testCommon
);
...
require('abstract-leveldown/abstract/put-get-del-test').setUp(
  factory,
  test,
  testCommon
);
...
require('abstract-leveldown/abstract/put-get-del-test').tearDown(
  test,
  testCommon
);
...
require('abstract-leveldown/abstract/batch-test').setUp(
  factory,
  test,
  testCommon
);
...
require('abstract-leveldown/abstract/chained-batch-test').setUp(
  factory,
  test,
  testCommon
);
...
require('abstract-leveldown/abstract/iterator-test').setUp(
  factory,
  test,
  testCommon
);
...
require('abstract-leveldown/abstract/iterator-test').iterator(
  factory,
  test,
  testCommon,
